...
Renders points color-coded by safety (green/orange/red) and supports click-to-select start/end or display a computed route.\
...
**model_inference.py:**\
YOLO model inference module for real-time road condition detection. Calculates safety scores from detected hazards.
...
**run_project.py:**\
Main script to set up and run the project. Checks dependencies, builds graph if needed, and starts the web application.
...
✅ **Component 1:** Data Collection and Annotation - Complete
✅ **Component 2:** Geospatial Mapping and Graph Construction - Complete  
✅ **Component 3:** AI Model Development - Complete
✅ **Component 4:** Intelligent Navigation System - Complete

## Documentation

- `SETUP_GUIDE.md` - Complete setup and usage guide
- `COMPONENT4_DOCUMENTATION.md` - Detailed Component 4 documentation
- `COMPONENT4_QUICKSTART.md` - Quick start for Component 4
- `COMPONENT4_SUMMARY.md` - Component 4 implementation summary

## Requirements

See `requirements.txt` for full list of dependencies.

Minimum: Python 3.8+, 8GB RAM, 50GB storage
Recommended: GPU for model inference